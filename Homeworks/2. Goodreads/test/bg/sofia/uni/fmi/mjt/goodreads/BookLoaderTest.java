...
public class BookLoaderTest {
    ...
    public void loadsSuccessfully() {
        ...
        Set<Book> actualBooks = BookLoader.load(new StringReader(csv));
        ...
        Assertions.assertEquals(Set.of(book1, book2),
                actualBooks,
                "Error in parsing books");
    }
}
